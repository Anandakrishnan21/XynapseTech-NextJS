...
export default function ContactForm({
  ...
  return (
    <div>
      <Html>
        <Head />
        <Preview>New message from Xynapse Technologies website</Preview>
        <Tailwind>
            ...
            <Container>
              <Section className="bg-white border border-gray-600 my-10 px-10 py-4 rounded">
                <Heading className="leading-tight text-2xl">
                  You recieved the following message from the Xynapse Technologies Pvt. Ltd. website contact form
                </Heading>
